...
(function(exports) {
  ...
  var eventDispatcher = {
     ...
     */
    dispatchEvent: function(eventName, parameters) {
      ensureValidEventName(eventName);
      ensureAllowedEventName(this.allowedEvents, eventName);
  ...
  exports.EventDispatcher = {
    /**
     * Mixes event dispatcher methods into target object.
     * @param {Object} target Object to mix event target methods into.
     * @param {Array.<string>} allowedEvents Optional list of the allowed event
     * names that can be dispatched and listened for.
